...
import (
	...
	spov1beta2 "github.com/AiflooAB/spark-on-k8s-operator/pkg/apis/sparkoperator.k8s.io/v1beta2"
	crdclientfake "github.com/AiflooAB/spark-on-k8s-operator/pkg/client/clientset/versioned/fake"
