...
import (
	v1beta2 "github.com/AiflooAB/spark-on-k8s-operator/pkg/apis/sparkoperator.k8s.io/v1beta2"
...
// List lists all SparkApplications in the indexer.
func (s *sparkApplicationLister) List(selector labels.Selector) (ret []*v1beta2.SparkApplication, err error) {
...
// List lists all SparkApplications in the indexer for a given namespace.
func (s sparkApplicationNamespaceLister) List(selector labels.Selector) (ret []*v1beta2.SparkApplication, err error) {
...
// Get retrieves the SparkApplication from the indexer for a given namespace and name.
func (s sparkApplicationNamespaceLister) Get(name string) (*v1beta2.SparkApplication, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta2.Resource("sparkapplication"), name)
	}
