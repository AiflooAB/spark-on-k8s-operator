...
import (
	...
	sparkoperatork8siov1beta2 "github.com/AiflooAB/spark-on-k8s-operator/pkg/apis/sparkoperator.k8s.io/v1beta2"
	versioned "github.com/AiflooAB/spark-on-k8s-operator/pkg/client/clientset/versioned"
	internalinterfaces "github.com/AiflooAB/spark-on-k8s-operator/pkg/client/informers/externalversions/internalinterfaces"
	v1beta2 "github.com/AiflooAB/spark-on-k8s-operator/pkg/client/listers/sparkoperator.k8s.io/v1beta2"
