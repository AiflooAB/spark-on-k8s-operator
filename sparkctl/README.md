...
To build `sparkctl`, make sure you followed build steps [here](https://github.com/AiflooAB/spark-on-k8s-operator/blob/master/docs/developer-guide.md#build-the-operator) and have all the dependencies, then run the following command from within `sparkctl/`:
